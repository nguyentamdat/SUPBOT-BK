...
var Botkit = {
    ...
    boot: function(user) {
        ...
        that.message_list = document.getElementById("chat");
        ...
        that.on('connected', function() {
            that.message_window.classList.add('connected');
            that.message_window.classList.remove("disconnected");
        ...
        that.on('disconnected', function() {
            that.message_window.classList.remove('connected');
            that.message_window.classList.add("disconnected");
